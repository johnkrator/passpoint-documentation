        ...
        <div className="min-h-screen bg-white dark:bg-gray-900">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Get Momo Payout Currency</h1>
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl">
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <CodeBlock>{`GET https://dev.mypasspoint.com/paypass/ft-app/currency-list/momo?type=payout`}</CodeBlock>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Your unique merchant identifier</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Channel identifier</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Channel code identifier</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
