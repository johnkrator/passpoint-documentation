...
const PayoutMomoGetNetwork = () => {
    const getEndpointCode = () => {
        return `GET https://dev.mypasspoint.com/paypass/momo-app/momo-networks/KES?type=payout&countryCode=KE`;
    };
        ...
        <div className="min-h-screen bg-white dark:bg-gray-950">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Get Momo Payout
                        Network</h1>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Country code
                                            for the payout destination
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
