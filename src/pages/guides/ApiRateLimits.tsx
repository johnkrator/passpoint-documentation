        ...
        <div className="min-h-screen bg-white dark:bg-gray-950">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">API Rate Limits</h1>

                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-12 leading-relaxed max-w-4xl">
                        Understanding and managing API rate limits is crucial for building robust, production-ready integrations with
                        Passpoint. This comprehensive guide explains how rate limiting works, best practices for handling limits, and
                        strategies for optimal API usage.
                    </p>

                    {/* Rate Limit Overview Section */}
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Rate Limit Structure</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            Passpoint implements rate limiting using a token bucket algorithm to ensure fair usage and maintain optimal
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Standard API</h3>
                                </div>
                                ...
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    Covers all standard API operations including wallet management, transfers, and transaction queries.
                                </p>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Webhooks</h3>
                                </div>
                                <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">100</div>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">webhook deliveries per minute per endpoint</p>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    Limits the rate of webhook events sent to your configured endpoints to prevent overwhelming your servers.
                                </p>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">File Uploads</h3>
                                </div>
                                <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-400 mb-2">50</div>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">file uploads per minute per API key</p>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mb-4">bulk operations per minute per API key</p>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    Batch operations like bulk transfers or mass wallet creation have stricter limits due to resource intensity.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Rate Limit Response Headers</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            Every API response includes rate limit information in the headers. Monitor these headers to implement
                        ...
                        <div className="mt-8 grid md:grid-cols-2 gap-6">
                            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                                ...
                                <p className="text-gray-700 dark:text-gray-300 text-sm">
                                    The maximum number of requests allowed in the current time window (typically 1 minute).
                                </p>
                            </div>
                            ...
                            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                                ...
                                <p className="text-gray-700 dark:text-gray-300 text-sm">
                                    The number of requests remaining in the current time window. Use this to avoid hitting the limit.
                                </p>
                            </div>
                            ...
                            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                                ...
                                <p className="text-gray-700 dark:text-gray-300 text-sm">
                                    Unix timestamp (seconds) indicating when the rate limit window resets and your quota refreshes.
                                </p>
                            </div>
                            ...
                            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                                ...
                                <p className="text-gray-700 dark:text-gray-300 text-sm">
                                    Number of seconds to wait before retrying. Only included in 429 Too Many Requests responses.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Handling Rate Limit Errors</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            When you exceed the rate limit, Passpoint returns a 429 Too Many Requests response. Your application
                        ...
                        <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-6 mb-8">
                            <div className="flex items-start gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-red-900 dark:text-red-100 mb-2">HTTP 429 Too Many Requests</h3>
                                    <p className="text-red-800 dark:text-red-200 text-sm">
                                        This response indicates you've exceeded your rate limit. Always respect the Retry-After header
                    ...
                    {/* Monitoring Section */}
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Rate Limit Monitoring</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            Implement proactive monitoring to track your rate limit usage and prevent hitting limits. This class-based
                        ...
                        <div className="space-y-4">
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Monitor Rate Limit Headers</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            Always check X-RateLimit-Remaining in responses. Implement warnings when you're approaching
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Implement Exponential Backoff with Jitter</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            Use exponential backoff with random jitter (0-1 second) to avoid thundering herd problems
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Use Bulk Endpoints When Available</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            Batch multiple operations into a single bulk request instead of making individual calls.
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Implement Client-Side Caching</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            Cache frequently accessed data (like wallet balances, transaction lists) to minimize
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Prefer Webhooks Over Polling</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            Use webhooks for real-time transaction updates instead of polling the status endpoint
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Distribute Load Across Multiple API Keys</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            For high-volume applications, create separate API keys for different services or
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                    <div>
                                        <h4 className="font-semibold text-green-900 dark:text-green-100 mb-1">Log and Alert on Rate Limit Events</h4>
                                        <p className="text-green-800 dark:text-green-200 text-sm">
                                            Set up monitoring and alerts when you receive 429 responses or when remaining requests
                                            drop below a threshold. This helps you identify and address usage patterns proactively.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Troubleshooting Rate Limits</h2>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                                ...
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                                    <li>• Review your integration architecture - are you polling when you could use webhooks?</li>
                                    ...
                                    <li>• Contact Passpoint support to discuss increasing your rate limits for production use</li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                                ...
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                                    ...
                                    <li>• Verify you're converting Unix timestamps correctly (seconds, not milliseconds)</li>
                                </ul>
                            </div>
                        </div>
                    </section>
