import { ArrowLeft, ArrowRight, RefreshCw, DollarSign, TrendingUp, Globe, CheckCircle, AlertTriangle, Clock } from "lucide-react";
...
const PayoutConvertFunds = () => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="max-w-none">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg mb-12 leading-relaxed max-w-4xl">
            Convert funds between different currencies in your Passpoint wallet with competitive exchange rates and instant settlement. Support for 40+ major currencies with real-time rate updates.
          </p>

          {/* Currency Conversion */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Currency Conversion</h2>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  ...
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Convert Currency</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Convert funds between different currencies in your wallet instantly with market-competitive exchange rates and transparent fees.
                  </p>
  ...
  "completed_at": "2024-01-15T14:30:00Z"
          ...
          {/* Exchange Rates */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Real-Time Exchange Rates</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <TrendingUp className="h-12 w-12 text-green-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Get Exchange Rates</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Retrieve current exchange rates for all supported currency pairs with bid/ask spreads and rate update timestamps.
                  </p>
  ...
  "rate_validity": 300
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Supported Currencies</h2>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 lg:p-8 shadow-sm mb-6">
              <div className="flex">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-blue-800 dark:text-blue-200">40+ Major Currencies</h3>
                  <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
                    Convert between all major global currencies with competitive rates updated in real-time from multiple liquidity providers.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Major Currencies</h3>
              ...
              {/* Asian Currencies */}
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Asian Currencies</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
              ...
              {/* Emerging Markets */}
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Emerging Markets</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
              ...
              {/* Crypto & Digital */}
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Digital Assets</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
          ...
          {/* Rate Lock Feature */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Rate Lock Feature</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <Clock className="h-12 w-12 text-purple-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Lock Exchange Rate</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Lock in favorable exchange rates for up to 10 minutes to protect against rate fluctuations during large conversions or planning periods.
                  </p>
  ...
  "created_at": "2024-01-15T14:30:00Z"
          ...
          {/* Conversion Fees */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Conversion Fees & Limits</h2>
            ...
            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-6 lg:p-8 shadow-sm mb-6">
              <div className="flex">
                <DollarSign className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5 mr-4"/>
                <div>
                  <h3 className="text-sm font-semibold text-green-800 dark:text-green-200">Competitive Rates</h3>
                  <p className="text-green-700 dark:text-green-300 text-sm mt-1">
                    Industry-leading exchange rates with transparent fees. No hidden markups or surprise charges.
                  </p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Conversion Amount</th>
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">$1 - $1,000</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.5% (min $2.50)</td>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.25% (min $5.00)</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.20%</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Instant</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">$10,000 - $100,000</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.15% (min $25.00)</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.15%</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Instant</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">Over $100,000</td>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.10% (min $150.00)</td>
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Market Hours & Considerations</h2>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6 lg:p-8 shadow-sm mb-6">
              <div className="flex">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-yellow-800 dark:text-yellow-200">Weekend & Holiday Rates</h3>
                  <p className="text-yellow-700 dark:text-yellow-300 text-sm mt-1">
                    Exchange rates may be less favorable during weekends and holidays when major forex markets are closed. Consider timing for large conversions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">24/7 Availability</h3>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Rate Optimization</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                  Our system aggregates rates from multiple liquidity providers to ensure competitive pricing.
                </p>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          ...
          <Link to="/payout/report">
            ...
            >
              ...
              <div className="text-left min-w-0">
                ...
                <div className="text-sm font-medium truncate">Payout Reports</div>
              </div>
            </Button>
          </Link>
          ...
          <Link to="/collection">
            ...
            >
              <div className="text-right min-w-0">
                ...
                <div className="text-sm font-medium truncate">Collections</div>
              </div>
