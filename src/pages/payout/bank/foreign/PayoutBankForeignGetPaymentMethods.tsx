        ...
        <div className="min-h-screen bg-white dark:bg-gray-900">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Get Payment Methods</h1>
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl">
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <CodeBlock>{`GET https://dev.mypasspoint.com/paypass/foreign-ft-app/available-payment-methods?countryCode=`}</CodeBlock>
                                        </div>
                                        <div>
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="bg-gray-50 dark:bg-gray-800">
                                            ...
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Default Value</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the selected country code</td>
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the response code of the operation. this indicates that the request was submitted successfully</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">responseDescription</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the description of the response code</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the array of payment methods</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">data.name</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the name of the payment method</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">data.alias</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the code for the payment method</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the minimum limit of the payment method</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">data.maxLimit</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">number</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the maximum limit of the payment method</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
