...
const PayoutBankForeignFednowUsd = () => {
    const getEndpointCode = () => {
        return `POST https://dev.mypasspoint.com/paypass/foreign-ft-app/make-payment/fednow`;
    };
    ...
    const getCurlExampleCode = () => {
        return `curl --location 'https://dev.mypasspoint.com/paypass/foreign-ft-app/make-payment/fednow' \\
        ...
        <div className="min-h-screen bg-white dark:bg-gray-900">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">FedNow - USD</h1>
                        ...
                        <div
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                                <div
                                    ...
                                    <Banknote className="h-12 w-12 text-brand-500"/>
