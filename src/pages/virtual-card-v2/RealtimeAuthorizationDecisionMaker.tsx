        ...
        <div className="min-h-screen bg-white dark:bg-gray-950">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="md:text-3xl text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 break-words">Realtime Authorization Decision Maker</h1>
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-start gap-4 sm:gap-6">
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl overflow-hidden">
                                    <div className="mb-4 sm:mb-6 break-words">
                                        <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 leading-relaxed"><strong>Endpoint:</strong> https://merchant_url</p>
                                        <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 leading-relaxed"><strong>Method:</strong> POST</p>
                                        <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 leading-relaxed"><strong>Description:</strong> This endpoint fetches a single card statement ledger by transaction id</p>
                                        <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 leading-relaxed"><strong>Authorization:</strong> Bearer Token (using Bearer Token from collection Passpoint Payment Service)</p>
                                    </div>
                                    <div className="space-y-3 sm:space-y-4">
                                        ...
                                        <div><h4 className="md:text-lg text-base font-semibold text-gray-900 dark:text-white mb-2">Response</h4><CodeBlock language="json">{responseCode()}</CodeBlock></div>
                                    </div>
                                </div>
                            </div>
                        </div>
