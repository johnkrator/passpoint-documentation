...
const Introduction = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <div className="prose prose-invert max-w-4xl">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Introduction to Passpoint Payment Service</h1>

        <p className="text-gray-700 dark:text-gray-300 text-lg mb-8 leading-relaxed">
          Passpoint Payment Service provides a comprehensive API suite for seamless integration of payment, wallet, transfer, and payout services across multiple currencies and regions. Our robust infrastructure enables businesses to process transactions globally with enterprise-grade security and reliability.
        </p>
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-6 sm:grid-cols-2 mb-8">
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center mb-4">
                <CreditCard className="h-8 w-8 text-blue-500 mr-3" />
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Payment Processing</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
                Accept payments through multiple channels including bank transfers, mobile money, and card processing with real-time settlement.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Wallet Management</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
                Create and manage digital wallets with multi-currency support, balance tracking, and transaction history.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Transfer Services</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
                Facilitate secure money transfers between wallets, banks, and mobile money accounts with transparent fees.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm">
                Operate across multiple countries with region-specific payment methods, currencies, and compliance requirements.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Bank-level security with comprehensive encryption, fraud detection, and regulatory compliance across all supported regions.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Real-time Processing</h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Fast transaction processing with instant notifications and real-time status updates through webhooks.
              </p>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-6">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <strong>Implement Authentication:</strong> Secure your API calls with proper authentication headers
                </div>
              </div>
              <div className="flex items-start">
  ...
  -d '{
    ...
    "initialBalance": 0
            ...
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mt-6">Standard Response Format</h4>
  ...
  "data": {
    ...
    "currency": "USD"
        ...
        <section className="mb-12">
          ...
          <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
              Passpoint Payment Service provides separate environments for development and production. Use the appropriate base URLs for your integration environment.
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-700 dark:text-gray-300">
                  <tr className="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <td className="py-3 px-4">Base URL for client user, API key and token generation</td>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg mb-8 leading-relaxed">
            Endpoints requiring authorization can use either Basic Authentication or Bearer Token Authentication methods.
          </p>

          <div className="space-y-8">
            {/* Basic Authentication */}
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">1. Basic Authentication</h3>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">2. Bearer Token Authentication</h3>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
              The following header parameters are mandatory for all API requests to Passpoint Payment Service.
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-700 dark:text-gray-300">
                  <tr className="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <td className="py-2 px-3">string</td>
                    <td className="py-2 px-3"><span className="bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 px-2 py-1 rounded text-xs">mandatory</span></td>
                    <td className="py-2 px-3">The channel ID (based on the channel used by the merchant to connect to our services)</td>
                  ...
                  <tr>
                    ...
                    <td className="py-2 px-3">string</td>
                    <td className="py-2 px-3"><span className="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 px-2 py-1 rounded text-xs">conditional</span></td>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm mb-6">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
              All API responses follow a consistent structure with the following parameters to indicate request status and processing results.
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-700 dark:text-gray-300">
                  <tr className="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <td className="py-2 px-3">string</td>
                    <td className="py-2 px-3">Determines whether the request was submitted successfully or not</td>
                    <td className="py-2 px-3 font-mono text-xs">00 → submitted<br/>01 → pending<br/>02 → failed</td>
                  </tr>
                  <tr className="border-b border-gray-100 dark:border-gray-800">
        ...
        <section className="mb-12">
          ...
          <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
              Comprehensive list of all status codes used throughout the Passpoint Payment Service API for detailed error handling and request tracking.
            </p>

            <div className="grid gap-4 md:grid-cols-2">
              {/* Success Codes */}
              <div>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Success & Processing</h4>
                <div className="space-y-2">
                  <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">00 ↔ successful</div>
                  </div>
                  <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">01 ↔ pending</div>
                  </div>
                  <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">01OTP ↔ pending_OTP_response</div>
                  </div>
                </div>
              </div>
              ...
              {/* Error Codes */}
              <div>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Error Codes</h4>
                <div className="space-y-2">
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">02 ↔ failed</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">03 ↔ service_unavailable</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">04 ↔ empty_request</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">05 ↔ empty_response</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">06 ↔ session_timeout</div>
                  </div>
                </div>
              </div>
              ...
              {/* Validation Codes */}
              <div>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Validation Errors</h4>
                <div className="space-y-2">
                  <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">30 ↔ failed_parameter_validation</div>
                  </div>
                  <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">31 ↔ invalid_parameter</div>
                  </div>
                  <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">40 ↔ no_record_found</div>
                  </div>
                </div>
              </div>
              ...
              {/* System Errors */}
              <div>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">System Errors</h4>
                <div className="space-y-2">
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">50 ↔ database_exception</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">51 ↔ general_exception</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">53 ↔ duplicate_exception</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">60 ↔ security_violation</div>
                  </div>
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                    <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">99 ↔ unknown_error</div>
                  </div>
                </div>
              </div>
            </div>
