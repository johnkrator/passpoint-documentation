                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-4 sm:gap-6">
                                    ...
                                    <div className="flex-1 min-w-0 lg:max-w-4xl overflow-hidden">
                                        <div className="mb-4 sm:mb-6 space-y-3 sm:space-y-4">
                                            <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300 leading-relaxed break-all">
                                                <strong className="block sm:inline mb-1 sm:mb-0">Endpoint:</strong> <span className="text-sm">https://dev.mypasspoint.com/cardapp/issue</span>
                                            </p>
