        ...
        <section className="mb-12">
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6">
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Initiation:</span>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6">
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Successful:</span>
                  <span>The transaction was completed without issues.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Pending:</span>
                  <span>The transaction is in progress and awaiting confirmation.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Failed:</span>
                  <span>The transaction could not be completed due to an error.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Cancelled:</span>
                  <span>The transaction was intentionally terminated before completion.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Refunded:</span>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6">
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Transaction Created:</span>
                  <span>Triggered when a new transaction is initiated.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Transaction Updated:</span>
                  <span>Triggered when there's a change in the transaction status.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Transaction Completed:</span>
                  <span>Triggered upon successful completion of a transaction.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Transaction Failed:</span>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6">
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Idempotency:</span>
                  <span>Implement idempotent operations to handle duplicate webhook events gracefully.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold text-gray-900 dark:text-white mr-2">Logging:</span>
