        ...
        <div className="min-h-screen bg-white dark:bg-gray-900">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Validate Momo Msisdn</h1>
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl">
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <CodeBlock>{`GET https://dev.mypasspoint.com/paypass/momo-app/validate-msisdn?msisdn=2347038025722`}</CodeBlock>
                                        </div>
                                    </div>
                                </div>
                            </div>
