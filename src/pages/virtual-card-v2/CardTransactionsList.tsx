...
const CardTransactionsList = () => {
    const endpointCode = () => {
        return `GET https://payment-sandbox.mypasspoint.com/passpoint-payserv/v1/virtual-card/card-transactions-list/{cardId}`;
    };
...
Authorization: Bearer [your-access-token]`;
    ...
    const curlCode = () => {
        return `curl --location 'https://payment-sandbox.mypasspoint.com/passpoint-payserv/v1/virtual-card/card-transactions-list/card_123456789?pageNumber=1&pageSize=10' \\
...
--header 'Authorization: Bearer [your-access-token]'`;
  ...
  "responseMessage": "15 transactions found",
  "totalCount": 15,
  "pageCount": 2,
  "pageSize": 10,
  "currentPage": 1,
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-12 leading-relaxed max-w-4xl">
                        Retrieve a paginated list of all transactions for a specific card.
                    </p>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                                    <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                                        <History className="h-12 w-12 text-indigo-500 flex-shrink-0"/>
                                    ...
                                    <div className="flex-1 min-w-0 lg:max-w-4xl">
                                        <div className="mb-6">
                                            <p className="text-gray-700 dark:text-gray-300 text-lg mb-4 leading-relaxed">
                                                <strong>Endpoint:</strong> https://payment-sandbox.mypasspoint.com/passpoint-payserv/v1/virtual-card/card-transactions-list/&#123;cardId&#125;
                                            </p>
                                            <p className="text-gray-700 dark:text-gray-300 text-lg mb-4 leading-relaxed">
                                                <strong>Method:</strong> GET
                                            </p>
                                            <p className="text-gray-700 dark:text-gray-300 text-lg mb-4 leading-relaxed">
                                                <strong>Description:</strong> Retrieve a paginated list of card transactions
                                            </p>
                                        </div>
