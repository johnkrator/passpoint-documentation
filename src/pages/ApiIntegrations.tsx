    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="prose prose-invert max-w-none">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-lg mb-8 leading-relaxed">
          Learn how to integrate Ramp APIs into your application with comprehensive guides, code examples, and best practices for production deployments.
        </p>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">REST API</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Direct HTTP calls to our RESTful endpoints with JSON payloads. Perfect for custom integrations and server-side applications.
                  </p>
                  <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 font-mono text-sm">
                    <div className="text-green-600 dark:text-green-400">curl -X POST https://api.ramp.com/v1/transactions \</div>
                    <div className="text-blue-600 dark:text-blue-400">  -H "Authorization: Bearer YOUR_API_KEY" \</div>
                    <div className="text-purple-600 dark:text-purple-400">  -H "Content-Type: application/json" \</div>
                    <div className="text-orange-600 dark:text-orange-400">  -d {`'{"amount": 1000, "currency": "USD"}'`}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Official libraries for popular programming languages with built-in error handling and retry logic.
                  </p>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="bg-gray-100 dark:bg-gray-800 rounded p-3">
                      <div className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Node.js</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">npm install @ramp/sdk</div>
                    </div>
                    <div className="bg-gray-100 dark:bg-gray-800 rounded p-3">
                      <div className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Python</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">pip install ramp-python</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Receive real-time notifications about transaction events, user actions, and system updates.
                  </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mb-6">
            <div className="flex">
              ...
              <div>
                <h3 className="text-sm font-semibold text-yellow-800 dark:text-yellow-200">API Key Security</h3>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 font-mono text-sm">
                <div className="text-gray-900 dark:text-gray-100">Authorization: Bearer sk_live_...</div>
              </div>
            </div>

            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Environment Keys</h3>
              <div className="grid gap-4 md:grid-cols-2">
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <div className="text-sm font-semibold text-green-800 dark:text-green-200 mb-2">Test Environment</div>
                  <div className="text-xs text-green-700 dark:text-green-300 font-mono mb-1">sk_test_...</div>
                  <div className="text-xs text-green-600 dark:text-green-400">Safe for development and testing</div>
                </div>
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <div className="text-sm font-semibold text-red-800 dark:text-red-200 mb-2">Live Environment</div>
                  <div className="text-xs text-red-700 dark:text-red-300 font-mono mb-1">sk_live_...</div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-4">Create a Transaction (Node.js)</div>
