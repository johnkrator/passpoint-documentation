...
const PayoutBankForeignAchUsd = () => {
    const getEndpointCode = () => {
        return `POST https://dev.mypasspoint.com/paypass/foreign-ft-app/make-payment/ach`;
    };
    ...
    const getCurlExampleCode = () => {
        return `curl --location 'https://dev.mypasspoint.com/paypass/foreign-ft-app/make-payment/ach' \\
