  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="prose prose-invert max-w-none">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Status Responses and Their Meanings</h1>

        <p className="text-gray-700 dark:text-gray-300 text-lg mb-8 leading-relaxed">
          Understanding API status codes and response patterns is crucial for building robust integrations. This guide explains all possible status responses and how to handle them appropriately.
        </p>
          ...
          <div className="space-y-6">
            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-green-800 dark:text-green-200 mb-3">2xx Success</h3>
                  <div className="space-y-3">
                    <div className="bg-white dark:bg-green-900/20 rounded p-3">
                      <div className="font-mono text-sm text-green-800 dark:text-green-200 mb-1">200 OK</div>
                      <div className="text-sm text-green-700 dark:text-green-300">Request successful, response contains data</div>
                    </div>
                    <div className="bg-white dark:bg-green-900/20 rounded p-3">
                      <div className="font-mono text-sm text-green-800 dark:text-green-200 mb-1">201 Created</div>
                      <div className="text-sm text-green-700 dark:text-green-300">Resource successfully created</div>
                    </div>
                    <div className="bg-white dark:bg-green-900/20 rounded p-3">
                      <div className="font-mono text-sm text-green-800 dark:text-green-200 mb-1">202 Accepted</div>
                      <div className="text-sm text-green-700 dark:text-green-300">Request accepted for processing</div>
                    </div>
                    <div className="bg-white dark:bg-green-900/20 rounded p-3">
                      <div className="font-mono text-sm text-green-800 dark:text-green-200 mb-1">204 No Content</div>
                      <div className="text-sm text-green-700 dark:text-green-300">Successful deletion or update with no response body</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-yellow-800 dark:text-yellow-200 mb-3">4xx Client Errors</h3>
                  <div className="space-y-3">
                    <div className="bg-white dark:bg-yellow-900/20 rounded p-3">
                      <div className="font-mono text-sm text-yellow-800 dark:text-yellow-200 mb-1">400 Bad Request</div>
                      <div className="text-sm text-yellow-700 dark:text-yellow-300">Invalid request format or missing required fields</div>
                    </div>
                    <div className="bg-white dark:bg-yellow-900/20 rounded p-3">
                      <div className="font-mono text-sm text-yellow-800 dark:text-yellow-200 mb-1">401 Unauthorized</div>
                      <div className="text-sm text-yellow-700 dark:text-yellow-300">Invalid or missing API key</div>
                    </div>
                    <div className="bg-white dark:bg-yellow-900/20 rounded p-3">
                      <div className="font-mono text-sm text-yellow-800 dark:text-yellow-200 mb-1">403 Forbidden</div>
                      <div className="text-sm text-yellow-700 dark:text-yellow-300">Valid API key but insufficient permissions</div>
                    </div>
                    <div className="bg-white dark:bg-yellow-900/20 rounded p-3">
                      <div className="font-mono text-sm text-yellow-800 dark:text-yellow-200 mb-1">404 Not Found</div>
                      <div className="text-sm text-yellow-700 dark:text-yellow-300">Requested resource does not exist</div>
                    </div>
                    <div className="bg-white dark:bg-yellow-900/20 rounded p-3">
                      <div className="font-mono text-sm text-yellow-800 dark:text-yellow-200 mb-1">429 Too Many Requests</div>
                      <div className="text-sm text-yellow-700 dark:text-yellow-300">Rate limit exceeded, retry after specified time</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-red-800 dark:text-red-200 mb-3">5xx Server Errors</h3>
                  <div className="space-y-3">
                    <div className="bg-white dark:bg-red-900/20 rounded p-3">
                      <div className="font-mono text-sm text-red-800 dark:text-red-200 mb-1">500 Internal Server Error</div>
                      <div className="text-sm text-red-700 dark:text-red-300">Unexpected server error, retry with exponential backoff</div>
                    </div>
                    <div className="bg-white dark:bg-red-900/20 rounded p-3">
                      <div className="font-mono text-sm text-red-800 dark:text-red-200 mb-1">502 Bad Gateway</div>
                      <div className="text-sm text-red-700 dark:text-red-300">Temporary server issue, safe to retry</div>
                    </div>
                    <div className="bg-white dark:bg-red-900/20 rounded p-3">
                      <div className="font-mono text-sm text-red-800 dark:text-red-200 mb-1">503 Service Unavailable</div>
                      <div className="text-sm text-red-700 dark:text-red-300">Service temporarily down for maintenance</div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    "request_id": "req_abc123"
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded p-4">
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300">Category of error (invalid_request_error, authentication_error, etc.)</div>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded p-4">
              <div className="font-semibold text-gray-900 dark:text-white mb-2">code</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Specific error code for programmatic handling</div>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded p-4">
              <div className="font-semibold text-gray-900 dark:text-white mb-2">message</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Human-readable error description</div>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded p-4">
              <div className="font-semibold text-gray-900 dark:text-white mb-2">field</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Specific field that caused the error (when applicable)</div>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded p-4">
              <div className="font-semibold text-gray-900 dark:text-white mb-2">request_id</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Unique identifier for debugging and support</div>
            </div>
          </div>
        </section>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-8 mt-8 border-t border-gray-200 dark:border-gray-800">
        ...
        >
          <div className="text-right min-w-0">
            ...
            <div className="text-sm font-medium truncate">Transaction Dynamics</div>
          </div>
