...
const CollectionGenerateUsdVirtualAccountBusiness = () => {
    const getEndpoint = () => `POST https://dev.mypasspoint.com/paypass/ft-app/generate-virtual-account?type=business`;
    ...
    "otherInfo": {
        ...
        "businessName": "string",
        "taxId": "string",
        "businessUrl": "http://localhost.com",
        "beneficialOwner": "string"
    }
}`;

    const getCurlRequest = () => `curl --location 'https://dev.mypasspoint.com/paypass/ft-app/generate-virtual-account?type=business' \\
                    ...
                    <section className="mb-12">
                        <div
                            ...
                            <p className="text-blue-800 dark:text-blue-400 text-sm">
                                This endpoint generates a USD virtual account for a business
                            </p>
                        </div>
                    </section>
                            ...
                            <table className="w-full text-sm border-collapse">
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    ...
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">the id number of the
                                        business contact person e.g. director of the business. support id types are
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    ...
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">the date of birth of the
                                        business contact person e.g. director of the business. Should be in the format
                                        yyyy-MM-dd
                                    </td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 font-mono text-gray-700 dark:text-gray-300">otherInfo.taxId</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">string</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">mandatory</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">the tax id of the
                                        business
                                    </td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 font-mono text-gray-700 dark:text-gray-300">otherInfo.businessName</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">string</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">mandatory</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">the business name</td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 font-mono text-gray-700 dark:text-gray-300">otherInfo.businessUrl</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">string</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">mandatory</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">the business website
                                        url
                                    </td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 font-mono text-gray-700 dark:text-gray-300">otherInfo.beneficialOwner</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">string</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">mandatory</td>
                                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">the name of one of the
                                        business owners who owns above 25% shares
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                            ...
                                            <div className="overflow-x-auto">
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                                        ...
                                                        <td className="px-4 py-3 text-gray-600 dark:text-gray-400">business</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
