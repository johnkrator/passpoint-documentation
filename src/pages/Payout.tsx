...
const Payout = () => {
                        ...
                        <div className="space-y-8">
                            <div
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                                    ...
                                    <div className="flex-1 min-w-0 lg:max-w-4xl">
                                        <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                            Track payout progress including compliance checks, processing updates, and
  ...
  "completed_at": "2024-01-17T16:22:00Z"
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                <div
                                    ...
                                    <div className="flex items-center mb-2">
                                        ...
                                        <span
                                            className="font-semibold text-yellow-800 dark:text-yellow-200">pending_compliance</span>
                                    </div>
                                    <p className="text-yellow-700 dark:text-yellow-300 text-sm">Compliance and fraud
                                        checks in progress</p>
                                </div>
                                ...
                                <div
                                    ...
                                    <p className="text-blue-700 dark:text-blue-300 text-sm">Compliance passed, ready for
                                        processing</p>
                                </div>

                                <div
                                    className="bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-xl p-6 lg:p-8 shadow-sm">
                                    <div className="flex items-center mb-2">
                                        <Clock className="h-6 w-6 text-purple-600 dark:text-purple-400 mr-4"/>
                                        <span
                                            className="font-semibold text-purple-800 dark:text-purple-200">processing</span>
                                    </div>
                                    <p className="text-purple-700 dark:text-purple-300 text-sm">Payout sent to
                                        recipient's bank</p>
                                </div>
                                ...
                                <div
                                    ...
                                    <p className="text-green-700 dark:text-green-300 text-sm">Payout delivered
                                        successfully</p>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Bulk Payouts */}
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Bulk
                            Payouts</h2>
                        ...
                        <div
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl">
                                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                        Execute multiple payouts in a single batch operation with comprehensive
                                        compliance checking and error handling.
                                    </p>
                                        ...
                                        <div className="flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-orange-700 dark:text-orange-300 text-sm mt-1">
                                                    Maximum 500 payouts per batch. Each payout subject to individual
                                                    compliance checks.
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <section className="mb-16">
                        ...
                        <div
                            ...
                            <div className="flex">
                                ...
                                <div>
                                    <h3 className="text-sm font-semibold text-red-800 dark:text-red-200">Compliance
                                        Notice</h3>
                                    <p className="text-red-700 dark:text-red-300 text-sm mt-1">
                                        All payouts are subject to anti-money laundering (AML) and sanctions screening.
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tr className="bg-gray-50 dark:bg-gray-800">
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Payout
                                            Amount
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Instant - 3
                                            days
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">1-5 business
                                            days
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">3-7 business
                                            days
                                        </td>
