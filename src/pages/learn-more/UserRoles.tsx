        ...
        <div className="min-h-screen bg-white dark:bg-gray-950">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">User Roles and
                        Permissions</h1>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">User Role Types</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            Passpoint implements three primary user roles with hierarchical permissions. Each role is designed
                            for specific use cases and provides appropriate access levels for security and operational efficiency.
                        </p>
                            ...
                            <div
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                    <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                                        ...
                                        <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Administrator</h3>
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                            Complete control over the Passpoint merchant account with unrestricted access to all features, settings, and sensitive operations.
                                        </p>
                            ...
                            <div
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                    <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                                        ...
                                        <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Manager</h3>
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                            Supervisory role with access to team operations, financial oversight, and limited user management for operational efficiency.
                                        </p>
                                        <div className="grid sm:grid-cols-2 gap-3">
                                            <div className="flex items-start gap-2">
                                                <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5"/>
                            ...
                            <div
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                    <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                                        ...
                                        <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Employee</h3>
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                            Basic operational access for individual contributors with permissions limited to personal transactions and assigned resources.
                                        </p>
                                        <div className="grid sm:grid-cols-2 gap-3">
                                            <div className="flex items-start gap-2">
                                                <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5"/>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Permission Matrix</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            This comprehensive matrix shows which operations each role can perform in the Passpoint system.
                        </p>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm border border-gray-200 dark:border-gray-700 rounded-lg">
                                ...
                                <tr>
                                    <th className="px-4 py-4 text-left font-semibold text-gray-900 dark:text-white">Feature / Operation</th>
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">View Personal Transactions</td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Submit Transactions</td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">View Team Transactions & Reports</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Approve/Reject Transactions</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Set Transaction Limits</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Manage Team Members (Limited)</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><AlertTriangle className="h-5 w-5 text-yellow-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Access Financial Analytics</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Manage API Keys</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Configure Webhooks</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Manage All Users & Roles</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Modify Account Settings</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium">Access Audit Logs</td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><XCircle className="h-5 w-5 text-gray-400 mx-auto"/></td>
                                    <td className="px-4 py-3 text-center"><CheckCircle className="h-5 w-5 text-green-500 mx-auto"/></td>
                                </tr>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">API Key Permission Levels</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            In addition to dashboard user roles, Passpoint supports granular API key permissions for programmatic
                            access control. This allows you to create API keys with specific scopes tailored to your integration needs.
                        </p>
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-xl p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-lg font-semibold text-green-900 dark:text-green-100">Read-Only Keys</h3>
                                </div>
                                <p className="text-green-800 dark:text-green-200 mb-4 text-sm leading-relaxed">
                                    Can retrieve data but cannot create or modify resources. Ideal for analytics, reporting, and monitoring integrations.
                                </p>
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-start gap-2 text-sm">
                                        <CheckCircle className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                                        <span className="text-green-800 dark:text-green-200">Check transaction status</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <CheckCircle className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5"/>
                            ...
                            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-950/20 dark:to-amber-950/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <Key className="h-8 w-8 text-yellow-600 dark:text-yellow-400"/>
                                    <h3 className="text-lg font-semibold text-yellow-900 dark:text-yellow-100">Limited Write Keys</h3>
                                </div>
                                <p className="text-yellow-800 dark:text-yellow-200 mb-4 text-sm leading-relaxed">
                                    Can create transactions and manage wallets but cannot modify account settings, webhooks, or user permissions.
                                </p>
                                <div className="space-y-2">
                                    <div className="flex items-start gap-2 text-sm">
                                        <CheckCircle className="h-4 w-4 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5"/>
                                        <span className="text-yellow-800 dark:text-yellow-200">Create transactions</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <CheckCircle className="h-4 w-4 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5"/>
                            ...
                            <div className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/20 dark:to-rose-950/20 border border-red-200 dark:border-red-800 rounded-xl p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <Shield className="h-8 w-8 text-red-600 dark:text-red-400"/>
                                    <h3 className="text-lg font-semibold text-red-900 dark:text-red-100">Full Access Keys</h3>
                                </div>
                                <p className="text-red-800 dark:text-red-200 mb-4 text-sm leading-relaxed">
                                    Complete API access equivalent to administrator-level permissions. Use with extreme caution and proper security measures.
                                </p>
                                <div className="space-y-2">
                                    <div className="flex items-start gap-2 text-sm">
                                        <CheckCircle className="h-4 w-4 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5"/>
                                        <span className="text-red-800 dark:text-red-200">All transaction operations</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <CheckCircle className="h-4 w-4 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5"/>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Implementation Example</h2>

                        <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-4xl">
                            Here's how to implement role-based access control in your application when integrating with Passpoint:
                        </p>
                        ...
                        <div className="mt-8 bg-brand-50 dark:bg-brand-950/20 border border-brand-200 dark:border-brand-800 rounded-lg p-6">
                            ...
                            <ul className="space-y-2 text-brand-800 dark:text-brand-200">
                                <li>• Follow the principle of least privilege - grant users only the permissions they need</li>
                                <li>• Use Limited Write API keys for production integrations instead of Full Access keys</li>
                                ...
                                <li>• Document which team members have which roles for compliance and auditing purposes</li>
                                <li>• Immediately revoke access when team members change roles or leave the organization</li>
                            </ul>
                        </div>
                    </section>
                </div>
