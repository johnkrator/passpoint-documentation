import { ArrowLeft, ArrowRight, Building2, BarChart3, ArrowRightLeft, DollarSign, CheckCircle, Clock, AlertTriangle } from "lucide-react";
...
const PayoutBankLocal = () => {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="max-w-none">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Local Bank Transfers</h1>
  ...
  "has_more": true
          ...
          {/* Account Enquiry */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Account Enquiry</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <BarChart3 className="h-12 w-12 text-blue-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Account Enquiry</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Verify bank account details and check account status before processing payouts to prevent failed transactions.
                  </p>
  ...
  "timestamp": "2024-01-15T14:30:00Z"
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Account Transfer - NGN</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <ArrowRightLeft className="h-12 w-12 text-green-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">NGN Bank Transfer</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Process domestic Nigerian Naira (NGN) bank transfers with instant settlement via the NIP (NIBSS Instant Payment) network.
                  </p>
  ...
  "created_at": "2024-01-15T14:30:00Z"
          ...
          {/* Passpoint Enquiry */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Passpoint Account Enquiry</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <BarChart3 className="h-12 w-12 text-purple-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Passpoint Enquiry</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Query Passpoint wallet account details, balance, and transaction history for internal wallet-to-wallet transfers.
                  </p>
  ...
  "last_activity": "2024-01-15T12:30:00Z"
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Passpoint Wallet Transfer</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <ArrowRightLeft className="h-12 w-12 text-orange-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Wallet Transfer</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Transfer funds between Passpoint wallets instantly with no fees for internal transactions within the platform.
                  </p>
  ...
  "completed_at": "2024-01-15T14:30:00Z"
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Processing Times & Fees</h2>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 lg:p-8 shadow-sm mb-6">
              <div className="flex">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-blue-800 dark:text-blue-200">Same-Day Processing</h3>
                  <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
                    Most domestic transfers complete within 4-6 hours during business days with same-day ACH.
                  </p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Transfer Type</th>
                      <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Processing Time</th>
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    <tr>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm font-medium text-gray-900 dark:text-white">Same-Day ACH</td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm text-gray-700 dark:text-gray-300">4-6 hours</td>
                    ...
                    <tr>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm font-medium text-gray-900 dark:text-white">Next-Day ACH</td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm text-gray-700 dark:text-gray-300">1 business day</td>
                    ...
                    <tr>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm font-medium text-gray-900 dark:text-white">Domestic Wire</td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm text-gray-700 dark:text-gray-300">2-4 hours</td>
                    ...
                    <tr>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-sm font-medium text-gray-900 dark:text-white">Passpoint Wallet</td>
