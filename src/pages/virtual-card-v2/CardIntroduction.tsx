                ...
                <div className="max-w-none">
                    ...
                    <section className="mb-12">
                        <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="md:text-xl text-lg font-semibold text-yellow-900 dark:text-yellow-100 mb-2">Authorization</h3>
                                    <p className="md:text-lg text-sm text-yellow-800 dark:text-yellow-200">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Issue Card</h3>
                                </div>

                                <div className="space-y-4 mb-6">
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300 break-words">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> POST</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Creates a virtual card</p>
                                </div>

                                <h4 className="md:text-lg text-base font-semibold text-gray-900 dark:text-white mb-3">Request Parameters:</h4>
                                <ParameterTable 
                                    columns={["Parameter", "Type", "Required", "Description", "Default Value"]} 
                                    data={issueCardRequestParams} 
                                />

                                <h4 className="md:text-lg text-base font-semibold text-gray-900 dark:text-white mb-3">Response Parameters:</h4>
                                <ParameterTable
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Fund Card</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> POST</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Funds a virtual card</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Withdraw From Card</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> POST</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Withdraw from a virtual card</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card Balance</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> GET</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Get card balance</p>
                                </div>

                                <h4 className="md:text-lg text-base font-semibold text-gray-900 dark:text-white mb-3">Query Parameters:</h4>
                                <ParameterTable 
                                    columns={["Parameter", "Type", "Required", "Description", "Default Value"]} 
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card Details</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> GET</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Get card details</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card Full Pan</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> GET</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Show Card Pan</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card Profile Status</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> GET</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> This retrieves the card status. It also tells if the card is active or terminated</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Freeze Card</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> PUT</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Freeze Card</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Unfreeze Card</h3>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Terminate Card</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> POST</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Terminate virtual card</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card Transaction</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> GET</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Get card transaction details</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card List</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> GET</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Get card list</p>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Card Event Callback</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> POST</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Sends callback for card events to merchant</p>
                                </div>

                                <h4 className="md:text-lg text-base font-semibold text-gray-900 dark:text-white mb-3">Header Parameters:</h4>
                                <ParameterTable 
                                    columns={["Parameter", "Type", "Required", "Description", "Default Value"]} 
                                    data={[
                                ...
                                <h4 className="md:text-lg text-base font-semibold text-gray-900 dark:text-white mb-3">Callback Parameters:</h4>
                                <ParameterTable
                            ...
                            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h3 className="md:text-xl text-lg font-bold text-gray-900 dark:text-white">Get Card Statement</h3>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Method:</strong> POST</p>
                                    <p className="md:text-lg text-sm text-gray-700 dark:text-gray-300"><strong>Description:</strong> Get card statement</p>
                                </div>
                    ...
                    <section className="mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">CARD CREATION WITHOUT FUNDING</h3>
                            ...
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">CARD CREATION WITH FUNDING</h3>
                            ...
                            {/* FUNDING */}
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">FUNDING</h3>
                            ...
                            {/* WITHDRAWAL */}
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">WITHDRAWAL</h3>
                            ...
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">AUTHORIZATION - NON CROSSBORDER</h3>
...
"isCrossborder":"boolean"
                            ...
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">AUTHORIZATION - CROSSBORDER</h3>
                                <CodeBlock language="json">{`{
"eventId": "string",
"amount": "decimal",
"merchantCity": "string",
...
"crossborderChargeDebitRef":"string"
                            ...
                            {/* REVERSAL */}
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">REVERSAL</h3>
                                <CodeBlock language="json">{`{
"eventId": "string", "amount": "decimal", "merchantCity": "string", "orderId": "string", "cardScheme": "string", "transactionMode": "credit", "eventType": "VIRTUAL_CARD_REVERSAL", "mcc": "string", "transactionId": "string", "originalTransactionId": "string", "merchantName": "string", "transactionType": "reversal", "cardReversalStatus": "approved", "cardId": "string", "currency": "string", "merchantCountry": "string", "responseMessage": "string", "isCrossborder":"boolean", "crossborderChargeReversalSuccessful":"boolean", "crossborderCharge":"decimal", "crossborderChargeBearer", "string", "crossborderChargeReversalReference":"string" }`}</CodeBlock>
                            ...
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">EXPIRED AUTHORIZATION</h3>
                                <CodeBlock language="json">{`{
"eventId": "string", "amount": "decimal", "merchantCity": "string", "orderId": "string", "cardScheme": "string", "transactionMode": "credit", "eventType": "VIRTUAL_CARD_EXPIRED_AUTHORIZATION_REFUND", "mcc": "string", "transactionId": "string", "originalTransactionId": "string", "merchantName": "string", "transactionType": "reversal", "cardReversalStatus": "approved", "cardId": "string", "currency": "string", "narration": "string", "merchantCountry": "string", "responseMessage": "string", "isCrossborder":"boolean", "crossborderChargeReversalSuccessful":"boolean", "crossborderCharge":"decimal", "crossborderChargeBearer", "string", "crossborderChargeReversalReference":"string" }`}</CodeBlock>
                            ...
                            {/* REFUND */}
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">REFUND</h3>
                                <CodeBlock language="json">{`{
"eventId": "string", "amount": "decimal", "merchantCity": "string", "orderId": "string", "cardScheme": "string", "transactionMode": "credit", "eventType": "VIRTUAL_CARD_REFUND", "mcc": "string", "merchantState": "string", "transactionId": "string", "merchantName": "string", "transactionType": "refund", "cardRefundStatus": "approved", "cardId": "string", "currency": "string", "merchantCountry": "string", "responseMessage": "string" }`}</CodeBlock>
                            ...
                            {/* DECLINE */}
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">DECLINE</h3>
                            ...
                            {/* CARD TERMINATION */}
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">CARD TERMINATION</h3>
                                <CodeBlock language="json">{`{
"eventId": "string", "amountWithdrawn": "decimal", "merchantId": "string", "maskedPan": "string", "cardId": "string", "dateCardDeactivated": "2024-07-15 16:51:36", "eventType": "VIRTUAL_CARD_TERMINATION", "cardProfileStatus": "terminated", "cardCreationStatus": "terminated", "transactionId": "string", "cardStatus": "deactivated" }`}</CodeBlock>
                            ...
                            <div>
                                <h3 className="md:text-xl text-lg font-semibold text-gray-900 dark:text-white mb-3">REFUND AFTER CARD TERMINATION</h3>
