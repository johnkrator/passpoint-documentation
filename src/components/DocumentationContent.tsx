import { ArrowLeft, ArrowRight, Globe, Shield, Zap, CreditCard } from "lucide-react";
...
const DocumentationContent = () => {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="max-w-none">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Passpoint Payment Service</h1>

          <p className="text-gray-700 dark:text-gray-300 text-lg mb-12 leading-relaxed max-w-4xl">
            Welcome to the Passpoint Payment Service API documentation. This comprehensive guide contains API requests and responses for seamless integration of payment, wallet, transfer, and payout services across multiple currencies and regions.
          </p>

          {/* Service Overview */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Service Overview</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Multi-Region Support</h3>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Comprehensive Payment Solutions</h3>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                  From wallet management to bank transfers, mobile money, and card processing - all in one unified API.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Environment Configuration</h2>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  ...
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Base URLs</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Configure your integration using the appropriate base URLs for sandbox testing and production environments.
                  </p>

                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Environment URLs</h4>
          ...
          {/* Response Format */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Standard Response Format</h2>

            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:text-center lg:min-w-0 lg:w-48 flex-shrink-0">
                  <Zap className="h-12 w-12 text-brand-500"/>
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white lg:mt-3">Response Structure</h3>
                </div>
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    All API responses follow a consistent structure to ensure predictable integration and error handling.
                  </p>

                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Standard Response Format</h4>
  ...
  "data": {
    ...
    // ... additional response data
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Response Codes</h4>
                      <div className="grid gap-3 sm:grid-cols-1">
                        <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded p-3">
                          <div className="font-mono text-sm font-medium text-gray-900 dark:text-white">00 - Success</div>
                          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Request submitted successfully</div>
                        </div>
                        <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded p-3">
                          ...
                          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Request is being processed</div>
                        </div>
                        <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded p-3">
                          ...
                          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Request failed to process</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          {/* Getting Started */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Getting Started</h2>
              ...
              <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <strong>Webhooks:</strong> Configure global callbacks for real-time notifications
                    </div>
                  </div>
                </div>
              </div>
