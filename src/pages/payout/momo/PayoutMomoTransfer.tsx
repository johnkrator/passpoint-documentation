...
const PayoutMomoTransfer = () => {
        ...
        <div className="min-h-screen bg-white dark:bg-gray-900">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl">
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <CodeBlock>{`POST https://dev.mypasspoint.com/paypass/momo-app/transfer`}</CodeBlock>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* Request Parameters */}
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Request Parameters</h2>
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead>
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the transaction amount</td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the transaction currency</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">e.g. KES, GHS</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">channel</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the channel through which the request is sent</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">1 - MOBILE_ANDROID, 2- MOBILE_IOS, 3- WEB, 4- THIRDPARTY, 5-USSD</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">msisdn</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the momo phone number</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the momo network service code. This can be obtained from here</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">passpoint default bank code</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">e.g. 000000</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">clientReference</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">uniquely generated reference used by the merchant to identify the transaction</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the payer country code</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the payer name</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the callback url where the final status of transaction will be sent</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">mandatory</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the description of the payment</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <section className="mb-16">
                        ...
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                            <div className="space-y-4">
                                <div>
                                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Example Request (JSON)</h4>
    ...
    "countryCode" : "KE"
                                ...
                                <div>
                                    ...
                                    <CodeBlock language="bash">{`curl --location 'https://dev.mypasspoint.com/paypass/momo-app/transfer' \\
--data '{
    "amount": "50",
    "narration": "test KES transfer",
    "serviceCode": "airtel",
  ...
  "data": {
    ...
    "transactionId": "string"
                    ...
                    {/* Response Parameters */}
                    <section className="mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Response Parameters</h2>
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead>
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the response code</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">e.g. 00- successful, 01-pending, 02-failed</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">responseDescription</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the response description</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">responseMessage</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">the response message</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">The details of the payment initiation</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">data.status</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">The status of the transaction</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">e.g. new, pending, successful, failed</td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">data.transactionId</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">string</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">The transaction id</td>
                                            <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">-</td>
                                        </tr>
                                    </tbody>
                                </table>
