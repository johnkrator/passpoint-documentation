        ...
        <div className="min-h-screen bg-white dark:bg-gray-950">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    <h1 className="md:text-3xl text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 break-words">Get Card Transaction</h1>
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-4 sm:gap-6">
                                    ...
                                    <div className="flex-1 min-w-0 lg:max-w-4xl overflow-hidden">
                                        <div className="mb-4 sm:mb-6 break-words">
                                            <p className="text-gray-700 dark:text-gray-300 md:text-lg text-sm mb-3 sm:mb-4 leading-relaxed"><strong>Endpoint:</strong> https://dev.mypasspoint.com/cardapp/get-card-trans?id=</p>
                                            <p className="text-gray-700 dark:text-gray-300 md:text-lg text-sm mb-3 sm:mb-4 leading-relaxed"><strong>Method:</strong> GET</p>
                                            <p className="text-gray-700 dark:text-gray-300 md:text-lg text-sm mb-3 sm:mb-4 leading-relaxed"><strong>Description:</strong> This is the endpoint used to get a card transaction using the transaction id or client order id</p>
