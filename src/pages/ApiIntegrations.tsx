import {ArrowLeft, ArrowRight, Terminal, Key, Globe, AlertTriangle, CheckCircle, Shield} from "lucide-react";
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-none">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-12 leading-relaxed max-w-4xl">
                        Learn how to integrate Passpoint Payment Service APIs into your application with comprehensive guides, code examples, and best practices for secure payment processing, wallet management, and transfer operations.
                    </p>
                    ...
                    <div className="space-y-4 mb-12">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 shadow-sm">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-200 mb-2">Token Expiry Notice</h3>
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                ...
                                <div className="flex-1">
                                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                        Direct HTTP calls to Passpoint Payment Service RESTful endpoints with JSON payloads. Perfect for custom integrations and server-side applications.
                                    </p>
    ...
    "initialBalance": 0
                        ...
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                ...
                                <div className="flex-1">
                                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                        While Passpoint Payment Service provides comprehensive REST APIs, you can create wrapper libraries for your preferred programming languages with built-in error handling and retry logic.
                                    </p>
                                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            ...
                                            <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">HTTP Client (axios/fetch)</div>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Python</div>
                                            <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">requests library</div>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Java</div>
                                            <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">OkHttp/HttpClient</div>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-2">PHP</div>
                                            <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">cURL/Guzzle</div>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-2">C#</div>
                                            <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">HttpClient</div>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow">
                                            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Go</div>
                                            <div className="text-xs text-gray-600 dark:text-gray-400 font-mono">net/http package</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                ...
                                <div className="flex-1">
                                    <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                                        Configure global callbacks to receive real-time notifications about transaction events, payment status changes, and system updates from Passpoint Payment Service.
                                    </p>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Authentication & Headers</h2>
                    ...
                    <div
                        ...
                        <div className="flex">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-yellow-800 dark:text-yellow-200">Security Best Practices</h3>
                                <p className="text-yellow-700 dark:text-yellow-300 text-sm mt-1">
                                    Never expose your access tokens in client-side code. Always make API calls from your secure server environment and implement proper token refresh strategies.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Required Headers</h3>
...
x-merchant-id: YOUR_MERCHANT_ID`}</CodeBlock>
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Environment URLs</h3>
                            <div className="grid gap-4 md:grid-cols-2">
                                <div
                                    className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                                    <div className="text-sm font-semibold text-green-800 dark:text-green-200 mb-2">Development Environment</div>
                                    <div className="text-xs text-green-700 dark:text-green-300 font-mono mb-1">https://dev.mypasspoint.com/</div>
                                    <div className="text-xs text-green-600 dark:text-green-400">Safe for development and testing</div>
                                </div>
                                <div
                                    className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                                    <div className="text-sm font-semibold text-red-800 dark:text-red-200 mb-2">Production Environment</div>
                                    <div className="text-xs text-red-700 dark:text-red-300 font-mono mb-1">https://app.mypasspoint.com/</div>
                                    <div className="text-xs text-red-600 dark:text-red-400">Processes real transactions</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Step 1: Get Access Token</h3>
                            <CodeBlock
...
async function getAccessToken() {
  try {
    ...
    console.error('Authentication failed:', error.response.data);
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Step 2: Create Wallet</h3>
                            <CodeBlock
...
async function createWallet(accessToken) {
  try {
    ...
    console.error('Wallet creation failed:', error.response.data);
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Complete Integration</h3>
                            <CodeBlock
