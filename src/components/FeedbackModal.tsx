...
const FeedbackModal: React.FC<FeedbackModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md mx-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 animate-in fade-in-0 zoom-in-95 duration-200">
        {/* Header */}
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <button
              ...
              onClick={() => window.open("https://support.anthropic.com/en/articles/8525519-privacy-policy", "_blank")}
            >
              Learn More
            </button>
          </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750 rounded-b-lg">
          <Button
            variant="outline"
            onClick={onClose}
