        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            <div className="prose prose-invert max-w-4xl">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-lg mb-8 leading-relaxed">
                    Understanding and managing API rate limits is crucial for building robust integrations with
                    Passpoint. This guide explains how rate limiting works, best practices for handling limits, and
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                        Passpoint implements rate limiting to ensure fair usage and maintain optimal performance for all
                        users. Our rate limits are designed to accommodate typical usage patterns while protecting
                        against abuse.
                    </p>
                    ...
                    <div className="space-y-8">
                        {/* Section 1 */}
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">1. Rate Limit
                                Structure</h3>
                            ...
                            <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6">
                                <li className="flex items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2">Standard API:</span>
                                ...
                                <li className="flex items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2">File Uploads:</span>
                                    <span>50 file uploads per minute per API key</span>
                                </li>
                                <li className="flex items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2">Bulk Operations:</span>
                        ...
                        {/* Section 2 */}
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">2. Response
                                Headers</h3>
                            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                            ...
                            <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6 mt-4">
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2 break-words">X-RateLimit-Limit:</span>
                                    <span className="break-words">Maximum requests allowed in the time window</span>
                                </li>
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2 break-words">X-RateLimit-Remaining:</span>
                                    <span
                                        className="break-words">Number of requests remaining in the current window</span>
                                </li>
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2 break-words">X-RateLimit-Reset:</span>
                                    <span className="break-words">Unix timestamp when the rate limit resets</span>
                                </li>
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                    <span
                                        className="font-semibold text-gray-900 dark:text-white mr-2 break-words">Retry-After:</span>
                        ...
                        {/* Section 3 */}
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">3. Handling Rate
                                Limits</h3>
                            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                            ...
                            <div
                                className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 font-mono text-sm mb-4 overflow-x-auto">
                                <div className="text-red-600 dark:text-red-400">
                                    ...
                                    <div className="ml-4">"message": "Too many requests. Please retry after 60
                                        seconds."
                                    </div>
                                    <div>{`}`}</div>
                                </div>
                            ...
                            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                                Implement exponential backoff and respect the Retry-After header to handle rate limits
                                gracefully.
                            </p>
                        </div>
                        ...
                        {/* Section 4 */}
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">4. Best
                                Practices</h3>
                            ...
                            <ul className="space-y-3 text-gray-700 dark:text-gray-300 ml-6">
                                ...
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                    ...
                                    <span
                                        className="break-words">Use exponential backoff with jitter for retry logic</span>
                                </li>
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                ...
                                <li className="flex flex-col sm:flex-row sm:items-start">
                                    ...
                                    <span
                                        className="break-words">Cache frequently accessed data to minimize API calls</span>
                                </li>
                                <li className="flex flex-col sm:flex-row sm:items-start">
