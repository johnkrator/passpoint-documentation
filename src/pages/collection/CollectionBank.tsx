import { ArrowLeft, ArrowRight, Building2, Shield, CreditCard, CheckCircle, AlertTriangle, Globe } from "lucide-react";
...
const CollectionBank = () => {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="max-w-none">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Bank Collections</h1>

          <p className="text-gray-700 dark:text-gray-300 text-lg mb-12 leading-relaxed max-w-4xl">
            Collect payments from bank accounts worldwide using Open Banking APIs and direct bank connections. Support for real-time account verification, payment requests, and automated settlement with comprehensive fraud protection.
          </p>

          {/* Collection Methods Overview */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Collection Methods</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white">Open Banking</h3>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                  Secure bank-to-bank payments using Open Banking APIs with instant account verification and real-time payment confirmation.
                </p>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white">Direct Bank Options</h3>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                  Virtual account generation and direct bank integrations for automated collections with ACH, SEPA, and local clearing systems.
                </p>
                <div className="space-y-2 text-sm mb-6">
                  <div className="flex justify-between">
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Account Verification</h2>
              ...
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                ...
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Verify customer bank account ownership and validity before processing payment requests to reduce failed payments and fraud.
                  </p>
  ...
  "verified_at": "2024-01-15T14:30:00Z"
          ...
          {/* Collection Features */}
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Collection Features</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Real-Time Verification</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Instantly verify bank account ownership and balance availability before processing payment requests.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Auto Reconciliation</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Automatically match incoming payments to invoices and customer accounts with transaction references.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Collect payments in multiple currencies with automatic conversion and competitive exchange rates.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Fraud Protection</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Advanced machine learning algorithms detect suspicious patterns and prevent fraudulent transactions.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Real-time webhooks and notifications for payment confirmations, failures, and status updates.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Built-in AML, KYC, and regulatory compliance for all supported jurisdictions and payment methods.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Payment Request Flow</h2>
            ...
            <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 max-w-none">
                ...
                <div className="flex-1 min-w-0 lg:max-w-4xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">
                    Create secure payment requests that customers can fulfill using their preferred bank account with optional tokenization for recurring payments.
                  </p>

                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Endpoint</h4>
                      <CodeBlock>{`POST /api/v1/payment-requests`}</CodeBlock>
                    </div>
  ...
  "created_at": "2024-01-15T14:30:00Z"
          ...
          <section className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Success Rates by Method</h2>
            ...
            <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-6 lg:p-8 shadow-sm mb-6">
              <div className="flex">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-green-800 dark:text-green-200">High Success Rates</h3>
                  <p className="text-green-700 dark:text-green-300 text-sm mt-1">
                    Our bank collection methods achieve industry-leading success rates with advanced fraud detection and real-time verification.
                  </p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Typical Fee</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">Open Banking</td>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.5% + $0.25</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">ACH Direct Debit</td>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">1.0% + $0.30</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">SEPA Direct Debit</td>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.8% + €0.35</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">Virtual Accounts</td>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">0.3% + $0.15</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <section className="mb-16">
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-red-700 dark:text-red-300 text-sm mt-1">
                    All bank collections are subject to regional banking regulations, Open Banking standards, and consumer protection laws.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                  Bank-grade security with PSD2 compliance, Strong Customer Authentication (SCA), and encrypted data transmission.
                </p>
              ...
              <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                  Licensed and regulated in all operating jurisdictions with full compliance to local banking and payment regulations.
                </p>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          ...
          <Link to="/collection/momo">
            ...
            >
              ...
              <div className="text-left min-w-0">
                ...
                <div className="text-sm font-medium truncate">Momo Collections</div>
              </div>
            </Button>
          </Link>
