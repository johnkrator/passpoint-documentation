                ...
                <div className="max-w-none">
                                ...
                                <div className="flex-1 min-w-0 lg:max-w-4xl">
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <CodeBlock>{`GET https://dev.mypasspoint.com/paypass/ft-app/bank-list/NG`}</CodeBlock>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <CodeBlock language="bash">{`curl --location 'https://dev.mypasspoint.com/paypass/ft-app/bank-list/NG'`}</CodeBlock>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-16">
                        ...
                        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 lg:p-8 shadow-sm">
                            <div className="space-y-4">
                                <div>
                                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Response Body</h4>
